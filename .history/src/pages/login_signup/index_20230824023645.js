...
export const LoginSignup = () => {
    ...
    function handleSubButton() {
        if(show)
        (showLogin) ? setShowSignup(true) setShowLogin() : setShowLogin(true)
    }
                        ...
                        <div className="w-full bg-white rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form
                                    ...
                                    <p className="text-center text-sm text-gray-500 dark:text-gray-400">
                                        Don’t have an account yet? <Link to={"/signup"}><a onClick={handleSubButton} href="#" className="font-medium text-primary hover:underline dark:text-primary">Sign up</a></Link>
                                    </p>
                                </form>
                            </div>
                        </div>
