                    ...
                    <div className="w-full bg-white rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" >
                                ...
                                <div>
                                    <Input id="password" type={(showPassword) ? "text" : "password"} name="password" placeholder="Password" onChange={(e) => setPassword(e.target.value)} insideButton={<button type='button' className='float-right font-bold text-black pr-2' onClick={handleClick}>Show</button>} />
                                </div>
                                {/* <div>
