...
export const Login = () => {
    return (
        <div>
            <section className="flex flex-col items-center justify-center  bg-white-50 dark:bg-white-900">
                <div className="flex flex-col items-center justify-center align-center px-6 py-8 mx-auto md:h-screen lg:py-0">
