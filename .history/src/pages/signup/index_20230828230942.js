                    ...
                    <div className="w-full bg-white rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleSignup} className="space-y-4 md:space-y-6" >
                                ...
                                <div>
                                    <Input id="confirm_password" type={(showPassword) ? "text" : "password"} name="confirm_password" placeholder="confirm_password" className={"focus:outline-none bg-gray-50 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5  dark:text-white"} innerButton={<button type='button' className='float-right font-bold text-black pr-2 pt-3' onClick={handleClick}>{buttonText}</button>} divStyling="flex bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg  block w-full dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" />
                                </div>
                                <div>
