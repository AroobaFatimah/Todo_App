...
export const Locations = () => {
    ...
    let addCurrentLocation = (event) => {
        ...
        let obj = {
            place: currentPlace,
            deadline: currentDirection
        }
        console.log(obj);
        previousLocations.shift(currentLocation);
    ...
    return (
        <>
            <div className=' mt-8 mb-5 '>
                ...
                <CreateModal addTask={addCurrentLocation} isModalOpen={isModalOpen} closeModal={closeModal} setCurrentPlace={setCurrentPlace} setCurrentDirection={setCurrentDirection} />
            </div>
        </>
    )
}
