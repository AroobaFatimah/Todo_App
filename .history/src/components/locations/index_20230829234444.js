                        ...
                        <div className=" px-6 py-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={addCurrentLocation} >
                                <div className="mb-3 flex " >
                                    <Input  onChange={(e) => setCurrentDirection(e.target.value)} type='text' placeholder='Current Direction' className='focus:outline-none'onChange={(e) => setCurrentPlace(e.target.value)} type='text' placeholder='Current Place' className='focus:outline-none' />
