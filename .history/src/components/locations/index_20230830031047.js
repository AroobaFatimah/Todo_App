        ...
        <>
            ...
            <div className=' mt-8 mb-5 max-md:mt-16 max-md:ml-5'>
                ...
                <div className='mt-7 ml-1'>
                    ...
                    <ul>
                        {previousLocations.map((location, i) => (
                            <li key className='flex mb-3'>
                                <div>
                                    <div className='flex'>
                                        <div className='w-5 h-5 mr-3'>
                                            <img src={locationIcon} />
                        ...
                        <div className=" px-6 py-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={addCurrentLocation} >
                                <div className="mb-3 flex " >
                                    <Input simpleInputField={true} onChange={(e) => setCurrentPlace(e.target.value)} type='text' placeholder='Current Place' className='focus:outline-none' />
                                </div>
                                <hr className='text-gray-600 ' />
                                <div className="mb-3 flex">
                                    <Input simpleInputField={true} onChange={(e) => setCurrentDirection(e.target.value)} type='text' placeholder='Current Direction' className='focus:outline-none' />
                                </div>
                                <hr className='text-gray-600' />
                                <div className="">
                                    <div className='flex justify-center'>
                                        <Button type={"submit"} className={'max-sm:px-24 bg-black text-white rounded-full px-32 py-2 mb-3 '} text={"Save"}></Button>
                                    </div>
                                    <div className='flex justify-center'>
