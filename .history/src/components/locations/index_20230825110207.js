            ...
            >
                <div className="relative w-full max-w-lg max-h-full">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div className="max-sm:w-80 px-6 py-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={addCurrentLocation} >
                                <div className="mb-3 flex" >
                                    ...
                                    <input onChange={(e) => setCurrentPlace(e.target.value)} type='text' placeholder='Current Place' className='focus:outline-none mx-2 w-full' />
                                </div>
