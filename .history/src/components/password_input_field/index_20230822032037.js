...
export const PasswordInput = ({
    ...
    onChange }) => {
    return (
        <div className="flex bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg  block w-full dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:">
            <input
                type={type}
                name={name}
                value={value}
