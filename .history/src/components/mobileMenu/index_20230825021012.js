...
export const MobileMenu = ({ mobileMenu, link1, link2, button1Styling, button2Styling, button1IconClr, button2IconClr }) => {
    return (
        <div>
            <div id="defaultModal" tabindex="-1" aria-hidden="true" class={`backdrop-bg-white fixed top-0 left-0 right-0 bottom-0 z-50 w-full h-full mt-10 mb-10 p-4 overflow-x-hidden overflow-y-hidden md:inset-0   ${mobileMenu ? "" : "hidden"}`}>
