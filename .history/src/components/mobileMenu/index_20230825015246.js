...
export const MobileMenu = ({ mobileMenu, link1, link2, button1Styling, button2Styling, button1IconClr, button2IconClr }) => {
    return (
        <div>
            <div id="defaultModal" tabindex="-1" aria-hidden="true" class={`backdrop-brightness-50 fixed top-0 left-0 right-0 z-50 w-full h-screen mt-10 p-4 overflow-x-hidden overflow-y-hidden md:inset-0   ${mobileMenu ? "" : "hidden"}`}>
                <div class="relative w-full h-full max-w-2xl ">

                    <div class="relative bg-white dark:bg-gray-700 w-full h-screen">
                        ...
                        <div>
                            ...
                            <div className='inline-block align botton'>
