...
export const MobileMenu = ({ mobileMenu, link1, link2, button1Styling, button2Styling, button1IconClr, button2IconClr }) => {
    return (
        <div>
            <div id="defaultModal" tabindex="-1" aria-hidden="true" class={`backdrop-brightness-50 fixed top-0 left-0 right-0 z-50 w-full h-full mt-10 p-4 overflow-x-hidden overflow-y-auto md:inset-0  max-h-full ${mobileMenu ? "" : "hidden"}`}>
