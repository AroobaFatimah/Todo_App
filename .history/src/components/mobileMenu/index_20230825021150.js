                ...
                <div class="relative w-full max-w-2xl ">
                    ...
                    <div class="relative bg-white dark:bg-gray-700 w-full h-screen mb-24">
                        ...
                        <div class="flex items-start justify-between p-4 dark:border-gray-600">
                            <button type="button" on class="text-gray-400 bg-transparent hover:text-gray-900  text-sm w-8 h-5 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="defaultModal">
