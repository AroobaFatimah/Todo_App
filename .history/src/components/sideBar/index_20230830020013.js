...
export const SideBar = ({ link1, link2, button1Styling, button2Styling, button1IconClr, button2IconClr }) => {
    ...
    const sidebarButtons = [
        ...
        },
        {
            ...
            InactiveIcon: <svg className='mr-3' enable-background="new 0 0 50 50" height="24px" id="Layer_1" version="1.1" viewBox="0 0 50 50" width="24px" xmlns="http://www.w3.org/2000/svg"><path d="M40,17  c0,13.604-15,31-15,31S10,30.928,10,17c0-8.285,6.715-15,15-15C33.284,2,40,8.715,40,17z" fill="none" stroke={""} stroke-linejoin="round" stroke-miterlimit="10" stroke-width="3" /><circle cx="25" cy="18" fill="none" r="6" stroke={"#000"} stroke-linejoin="round" stroke-miterlimit="10" stroke-width="3" /></svg>
        },
