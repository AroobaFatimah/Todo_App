            ...
            <div className='block justify-between md:w-1/2 lg:w-1/4 mt-5 mb-5 max-md:hidden'>
                <div>
                    {sidebarButtons.map((button, index) => (
                        <SideBarButton key={index} IconClr={button.activeIconClr} text={button.text} isActive={button.link === activeButton} activeIcon={button.ActiveIcon} inactiveIcon={button} />
                    ))}
                </div>
                <div>
