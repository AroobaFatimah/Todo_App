...
const SideBarButton = ({ text, link, isActive, svg, btnIconClr }) => {
    return (
        <Link to={link} svg={svg} className={isActive ? "font-semibold flex bg-black w-1/2  px-4 py-2 pl-10 text-sm text-white rounded-full rounded-l-none mb-3" : "text-black font-semibold flex w-1/2 px-4 py-2 pl-10 text-sm bg-white"} btnIconClr={btnIconClr} >
            <div className='flex justify-center items-center'>{svg}{text}</div>
        </Link>
    );
};

export const SideBar = ({ btnIconClr, link1, link2, button1Styling, button2Styling, button1IconClr, button2IconClr }) => {
    const sidebarButtons = [
        { text: 'Tasks', link: '/tasks', svg: <svg className='mr-3 stroke-5' fill="none" viewBox="0 0 20 20" width="24" height="24" xmlns="http://www.w3.org/2000/svg" ><path stroke={btnIconClr = { btnIconClr}} stroke-width='0.3' d="M9.35355 7.85356C9.54881 7.65831 9.54882 7.34172 9.35357 7.14646C9.15831 6.95119 8.84173 6.95118 8.64646 7.14644L7.23436 8.55847L6.8372 8.19572C6.6333 8.0095 6.31704 8.02382 6.13081 8.22772C5.94459 8.43162 5.95891 8.74788 6.16281 8.9341L6.91281 9.6191C7.11021 9.79939 7.41451 9.79251 7.60355 9.60347L9.35355 7.85356ZM9.35357 12.1465C9.54882 12.3417 9.54881 12.6583 9.35355 12.8536L7.60355 14.6035C7.41451 14.7925 7.11021 14.7994 6.91281 14.6191L6.16281 13.9341C5.95891 13.7479 5.94459 13.4316 6.13081 13.2277C6.31704 13.0238 6.6333 13.0095 6.8372 13.1957L7.23436 13.5585L8.64646 12.1464C8.84173 11.9512 9.15831 11.9512 9.35357 12.1465ZM11 13C10.7239 13 10.5 13.2239 10.5 13.5C10.5 13.7761 10.7239 14 11 14H13.5C13.7761 14 14 13.7761 14 13.5C14 13.2239 13.7761 13 13.5 13H11ZM10.5 8.5C10.5 8.22386 10.7239 8 11 8H13.5C13.7761 8 14 8.22386 14 8.5C14 8.77614 13.7761 9 13.5 9H11C10.7239 9 10.5 8.77614 10.5 8.5ZM8.5 2C7.84689 2 7.29127 2.4174 7.08535 3H5.5C4.67157 3 4 3.67157 4 4.5V16.5C4 17.3284 4.67157 18 5.5 18H14.5C15.3284 18 16 17.3284 16 16.5V4.5C16 3.67157 15.3284 3 14.5 3H12.9146C12.7087 2.4174 12.1531 2 11.5 2H8.5ZM8 3.5C8 3.22386 8.22386 3 8.5 3H11.5C11.7761 3 12 3.22386 12 3.5C12 3.77614 11.7761 4 11.5 4H8.5C8.22386 4 8 3.77614 8 3.5ZM5.5 4H7.08535C7.29127 4.5826 7.84689 5 8.5 5H11.5C12.1531 5 12.7087 4.5826 12.9146 4H14.5C14.7761 4 15 4.22386 15 4.5V16.5C15 16.7761 14.7761 17 14.5 17H5.5C5.22386 17 5 16.7761 5 16.5V4.5C5 4.22386 5.22386 4 5.5 4Z" fill={btnIconClr} /></svg> },
            ...
            <div className='block justify-between md:w-1/2 lg:w-1/4 mt-5 mb-5 max-md:hidden'>
                <div>
                    {sidebarButtons.map((button, index) => (
                        <SideBarButton key={index} text={button.text} link={button.link} svg={button.svg} isActive={button.link === activeButton} btnIconClr={(button.link === activeButton) ? "#fff" : "#000"} />
                    ))}
                </div>
                <div>
