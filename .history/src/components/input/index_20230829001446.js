    ...
    return (
        <>
            <div className={divStyling}>
                ...
                />
                <Button type='button' className={`float-right font-bold text-gray-900 bg-white pr-2 mt-2  ${(simpleInputField) ? "hidden" : ""}`} onClick={handleClick} text={buttonText}></Button>
