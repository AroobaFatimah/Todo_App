    ...
    return (
        <>
            <div
                ...
                aria-hidden="true"
                class={`backdrop-blur fixed flex justify-center items-center z-50 w-full p-10 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full ${(isModalOpen ? " " : "hidden")
                    }`}
            >
                <div class="relative w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="px-6 py-6 lg:px-8">
                            <h3 class="mb-4 text-md font-semibold text-gray-900 dark:text-white">
                                New Task
                            </h3>
                            <form class="space-y-6" onSubmit={handleClick} >
                                ...
                                <div className="mb-3 flex">
                                    ...
                                    <textarea rows={3} cols={50} placeholder='Description' className='focus:outline-none' />
                                </div>
                                <hr className='text-gray-600' />
                                <div className="mb-3 flex">
                                    <img className='mr-3' src={ClockIcon} width="20px" height="20px" />
                                    <input type='text' placeholder='Due Date' className='focus:outline-none' />
                                </div>
                                <hr className='text-gray-600' />
                                <div className="">
                                    <Button text="Save" type="submit" size="large" variant="primary" className="mb-3 w-1/2 " onClick={handleClick} >
                                    </Button>
                                    <Button
                                        text="Cancel"
                                        type="button"
