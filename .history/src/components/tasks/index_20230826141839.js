...
export const Tasks = ({ checked }) => {
    ...
    let ShowAlarm = () => {
        ...
        const currentYear = dateA.getFullYear();
        const currentMonth = dateA.getMonth();
        const currentDay = dateA.getDate();
        const currentHour = dateA.getHours();
        const currentMinute = dateA.getMinutes();
