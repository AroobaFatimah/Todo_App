...
export const Tasks = ({ checked }) => {
    ...
    let ShowAlarm = () => {
        let dates = items.map(item => item.deadline);
        console.log(dates.map(date =>)
                        ...
                        <div className="px-6 py-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={addTask} >
                                ...
                                <div className="mb-3 flex">
                                    ...
                                    <input type='date' onChange={(e) => setDueDate(e.target.value)} placeholder='Due Date' className='focus:outline-none' />
                                </div>
                                <hr className='text-gray-600' />
                                <div className="">
