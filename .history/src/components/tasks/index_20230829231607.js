                                ...
                                return (
                                    <>
                                        <li className='flex mb-3'>
                                            <Input simpleInputField={true} onClick={() => taskCompleted(item.id)} checked={clicked} className='w-4 h-4 rounded-sm border border-gray-200 bg-gray-100 accent-slate-50 mr-3 mt-1' type='checkbox' />
