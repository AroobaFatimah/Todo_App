                        ...
                        {items.map((item, index) => {
                            return (
                                <li className='flex mb-3'>
                                    <input onClick={() => taskCompleted(item.id)} className='w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 rounded focus:ring-gray-100 dark:focus:ring-blue-600 mr-3 mt-1' type='checkbox'></input>
                                    <div>
