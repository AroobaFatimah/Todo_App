...
function CreateModal({ isModalOpen, closeModal, handleModalClose, handleClick }) {
    return (
        <>
            <div
                        ...
                        <div className="px-6 py-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={handleClick} >
                                <div className="mb-3 flex">
                                    ...
                                    <input onChange=onChange={(e) => setTitle(e.target.value)} type='text' placeholder='Summary' className='focus:outline-none' />
                                </div>
