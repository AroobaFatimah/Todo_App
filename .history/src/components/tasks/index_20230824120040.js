    ...
    return (
        <>
            ...
            <div className='flex w-3/4'>
                ...
                />
                <div>
                    <Alarm CloseAlarm={CloseAlarm} ShowAlarm = { ShowAlarm } showAlarm={showAlarm} setShowAlarm={setShowAlarm} taskSummary={alarmSummary} taskDesc={alarmDesc} />
                </div>
            </div>
        </>
    )
...
const Alarm = ({ CloseAlarm, ShowAlarm, showAlarm, setShowAlarm, taskSummary, taskDesc }) => {
