    ...
    return (
        <>
            ...
            <div className='flex w-3/4 '>
                ...
                <CreateModal setIsModalOpen={setIsModalOpen} setCloseAlarm={setCloseAlarm} addTask={addTask} isModalOpen={isModalOpen} closeModal={closeModal} setSummary={setSummary} setDescription={setDescription} setDueDate={setDueDate}
                />
                <div>
...
function CreateModal({ isModalOpen, setIsModalOpen, closeModal, addTask, summary, setSummary, description, setDescription, dueDate, setDueDate, setCloseAlarm }) {
    return (
        <>
            <div
                        ...
                        <div className="px-6 py-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={addTask} >
                                ...
                                <div className="">
                                    ...
                                    <div className='flex justify-center'>
                                        <Button onClick={setIsModalOpen(false)} type='button' className='bg-white text-black font-semibold mb-3 ' text={"Cancel"} />
                                    </div>
                                </div>
                            </form>
                        </div>
