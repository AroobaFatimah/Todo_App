...
export const Tasks = ({ checked }) => {
    ...
    return (
        <>
            ...
            <div className='flex w-3/4 max-md:mt-7'>
                <div className=' mt-8 mb-5 max-md:pl-5'>
        ...
        <>
            ...
            >
                <div className=" relative max-w-lg max-h-full">
                    <div className="max-sm:w-82 relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div className="px-6 py-6 lg:px-8">
                            <h3 className="mb-4 text-md font-semibold text-gray-900 dark:text-white">
                                New Task
                            </h3>
                            <form className="space-y-1" onSubmit={addTask} >
