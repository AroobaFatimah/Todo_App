...
const Alarm = ({ setRemindMeLater, setCloseAlarm, ShowAlarm, showAlarm, setShowAlarm, taskSummary, taskDesc }) => {
    ...
    return (
        <>
            ...
            <div className={`absolute right-0 max-sm:w-full md:fixed md:flex md:justify-center md:items-center md:z-50 md:w-full w-1/4 mt-5 mb-5 mr-3`}>
