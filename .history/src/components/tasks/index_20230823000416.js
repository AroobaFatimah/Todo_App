                        ...
                        {items.map((item, index) => {
                            return (
                                <li className='flex mb-3'>
                                    <input onClick={() => taskCompleted(item.id)} className='w-4 h-4 rounded-sm border border-gray-100 bg-gray-100 accent-slate-50 mr-3 mt-1' type='checkbox'></input>
                                    <div>
                ...
                <div className='mt-5 ml-1'>
                    ...
                    <ul>
                        {completedItems.map(item => {
                            return (
                                <li className='flex mb-3'>
                                    <input className='w-4 h-4 mr-3 bg-gray-100 accent-slate-200' type='checkbox' checked></input>
                                    <div>
