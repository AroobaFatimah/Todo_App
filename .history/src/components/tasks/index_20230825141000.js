...
export const Tasks = ({ checked }) => {
    ...
    let moveTaskToIncompletedTaskList = (id) => {
        if (unCheck) {
            ...
            selectedItemIndex = com.indexOf(selectedItem);
                    ...
                    <div className='mt-5 ml-1'>
                        ...
                        <ul>
                            {completedItems.map(item => {
                                return (
                                    <li className='flex mb-3'>
                                        <input onClick={() => { setUnCheck(true); moveTaskToIncompletedTaskList(item.id) }} className='w-4 h-4 mr-3 bg-white border border-gray-200 accent-slate-200' type='checkbox' checked></input>
                                        <div>
