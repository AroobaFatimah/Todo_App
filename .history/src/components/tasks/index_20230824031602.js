                    ...
                    <div className="relative w-full max-w-2xl max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="flex justify-end bg-gray-100 p-3 space-x-2 rounded-b dark:border-gray-600">
                                <button onClick={() => (showAlarm) ? setShowAlarm(false) : ""} className='text-sm font-semibold text-black mr-3'>Skip</button>
                                <button onClick={() => (showAlarm) ? setShowAlarm(false) : ""} className='text-sm font-semibold text-black'>Remind me later</button>
                            </div>
                        </div>
                    </div>
                </div>
