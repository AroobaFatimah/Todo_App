    ...
    return (
        <>
            ...
            <div className={`absolute right-0 w-1/4 max-md:w-full max-md:mr-0 mt-5 mb-5 mr-3`}>
                <div id="defaultModal" tabindex="-1" aria-hidden="true" className={`max-xl:backdrop-brightness-50 max-xl:fixed max-lg:flex max-xl:justify-center max-xl:items-center  z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full ${(showAlarm) ? "" : "hidden"}`}>
