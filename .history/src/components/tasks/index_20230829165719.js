    ...
    return (
        <>
            ...
            <div className='flex w-3/4 '>
                ...
                <CreateModal addTask={addTask} isModalOpen={isModalOpen} closeModal={closeModal} setSummary={setSummary} setDescription={setDescription} setDueDate={setDueDate} summary={summary} description={description} dueDate={dueDate}
                />
                <div>
                        ...
                        <div className="px-6 py-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={addTask} >
                                <div className="mb-3 flex" >
                                    ...
                                    <input onChange={(e) => setSummary(e.target.value)} type='text' placeholder='Summary' className='focus:outline-none' value={summary} />
                                </div>
                                ...
                                <div className="mb-3 flex">
                                    ...
                                    <input value={dueDate} type='datetime-local' onChange={(e) => {
                                ...
                                <div className="">
                                    <div className='flex justify-center'>
                                        <Button type='submit' className='max-sm:px-24 bg-black text-white rounded-full px-32 py-2 mb-3 ' text={"Save"} />
                                    </div>
                                    <div className='flex justify-center'>
