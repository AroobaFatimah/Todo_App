                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <form class="space-y-6" onSubmit={handleClick} >
                                <div className="mb-6">
                                    <svg height="20" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path stroke='#575767' d="M12.0867962,18 L6,21.8042476 L6,18 L4,18 C2.8954305,18 2,17.1045695 2,16 L2,4 C2,2.8954305 2.8954305,2 4,2 L20,2 C21.1045695,2 22,2.8954305 22,4 L22,16 C22,17.1045695 21.1045695,18 20,18 L12.0867962,18 Z M8,18.1957524 L11.5132038,16 L20,16 L20,4 L4,4 L4,16 L8,16 L8,18.1957524 Z M7,13 L7,11 L14,11 L14,13 L7,13 Z M7,9 L7,7 L16,7 L16,9 L7,9 Z" /></svg>
                                </div>
                                <div className="mb-6">
                                    <Input
                                        label="Author"
