...
export const Tasks = ({ checked }) => {
    ...
    itemSelectedForAlarm = items.filter(item => (item.deadline == currentDate))

    (itemSelectedForAlarm.length == 0) ? setShowAlarm(false) : setShowAlarm(true) }
    ...
    return (
        <>
            <div className='flex w-3/4'>
                ...
                />
                <div>
                    <Alarm showAlarm={showAlarm} setShowAlarm={setShowAlarm} />
...
const Alarm = ({ showAlarm, setShowAlarm, taskSummary = "Submit Resume", taskDesc = "Send resume to head office!" }) => {
