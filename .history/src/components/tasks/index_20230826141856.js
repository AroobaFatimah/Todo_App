...
export const Tasks = ({ checked }) => {
    ...
    let ShowAlarm = () => {
        ...
        const currentYear = curre.getFullYear();
        const currentMonth = curre.getMonth();
        const currentDay = curre.getDate();
        const currentHour = curre.getHours();
        const currentMinute = curre.getMinutes();
