    ...
    return (
        <>
            ...
            <div className={`absolute right-0 max-sm:w-full w-1/4 mt-5 mb-5 mr-3`}>
                <div id="defaultModal" tabindex="-1" aria-hidden="true" className={`md:fixed md:flex justify-center items-center  max-md:ml-3 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full ${(showAlarm) ? "" : "hidden"}`}>
