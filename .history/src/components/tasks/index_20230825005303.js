...
function MobileMenu({ mobileMenu, setMobileMenu }) {
    return (
        <>
            <div id="defaultModal" tabindex="-1" aria-hidden="true" class={` right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full ${mobileMenu ? "" : "hidden"}`}>
