    ...
    return (
        <>
            <div
                ...
                aria-hidden="true"
                className={`backdrop-brightness-500 fixed flex justify-center items-center z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full ${(isModalOpen ? " " : "hidden")
                    }`}
            >
