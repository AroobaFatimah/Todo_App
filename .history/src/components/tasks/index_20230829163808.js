    ...
    return (
        <>
            ...
            <div className='flex w-3/4 '>
                ...
                <CreateModal setCloseAlarm={setCloseAlarm} addTask={addTask} isModalOpen={isModalOpen} closeModal={closeModal} setSummary={setSummary} setDescription={setDescription} setDueDate={setDueDate} summary={summary} description={description} dueDate={due}
                />
                <div>
