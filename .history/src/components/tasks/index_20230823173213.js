...
export const Tasks = ({ checked }) => {
    ...
    useEffect(() => {
        ...
        const myFunction = () => {
          console.log('Function called every minute');
          // Your code here...
        };
        ...
        const intervalId = setInterval(myFunction, 60000); // 60000 ms = 1 minute
    ...
    return (
        <>
            ...
            <div className='flex w-3/4'>
                ...
                />
                <div>
                    <Alarm ShowAlarm={ShowAlarm} showAlarm={showAlarm} setShowAlarm={setShowAlarm} />
