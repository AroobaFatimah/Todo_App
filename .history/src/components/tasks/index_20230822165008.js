                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <form class="space-y-6" onSubmit={handleClick} >
                                ...
                                <div className="">
                                    <div></div>
                                    <button type='submit' className='bg-black text-white rounded-full px-24 py-2 mb-3 flex justify-center'>Save</button>
                                    <Button text="Save" type="submit" size="large" variant="primary" className="mb-3 w-50 " onClick={handleClick} >
                                    </Button>
                                    <Button
                                        text="Cancel"
                                        type="button"
