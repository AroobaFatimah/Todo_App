    ...
    return (
        <>
            ...
            <div className='flex w-3/4 '>
                ...
                <CreateModal setIsModalOpen={set} setCloseAlarm={setCloseAlarm} addTask={addTask} isModalOpen={isModalOpen} closeModal={closeModal} setSummary={setSummary} setDescription={setDescription} setDueDate={setDueDate}
                />
                <div>
