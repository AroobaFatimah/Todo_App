    ...
    return (
        <>
            ...
            <div className={`absolute right-0 w-1/4 mt-5 mb-5 mr-3`}>
                <div id="defaultModal" tabindex="-1" aria-hidden="true" className={`max-lg:backdrop-brightness-50 max-lg:fixed max-lg:flex max-lg:justify-center max-lg:items-center max-lg:e z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full ${(showAlarm) ? "" : "hidden"}`}>
