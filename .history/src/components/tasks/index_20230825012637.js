        ...
        <>
            ...
            <div className='fixed top-0 left-0 w-full flex justify-between items-center md:hidden bg-black text-white px-5 py-3'>
                ...
                <div className='w-5 h-5 '>
                    ...
                    <MobileMenu mobileMenu={mobileMenu} link1={"/tasks"} link2={"/location"} button1Styling="font-semibold flex bg-black w-full px-4 py-2 justify-center text-sm text-white  rounded-l-none mb-3" button2Styling='font-semibold flex w-1/2 px-4 py-2 pl-10 text-center text-sm ' button1IconClr="#fff" button2IconClr="#000" />
                </div>
            </div>
