...
export const Tasks = () => {
    ...
    let taskCompleted = (id) => {
        ...
        let poppedItem = items.splice(selectedItemIndex, 1);
        setItems([...items]);
        completedTasks.push(poppedItem);
    ...
    return (
        <>
            <div className='w-1/2 mt-5 mb-5 '>
                        ...
                        {items.map((item, index) => {
                            return (
                                <li className='flex mb-3'>
                                    <input className='mr-3 -mt-6' type='checkbox'></input>
                                    <div>
                ...
                <div className='mt-5 ml-1'>
                    <h3 className='font-semibold text-gray-600 mb-2'>complete</h3>
                    <ul>
                        {items.map((item, index) => {
                            return (
                                <li className='flex mb-3'>
