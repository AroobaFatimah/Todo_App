        ...
        <>
            ...
            <div className='absolute top-0 left-0 w-full flex justify-between items-center md:hidden bg-black text-white px-5 py-3'>
                ...
                <div className='w-5 h-5 '>
                    <img src={Menu} onClick={<CreateModal></CreateModal>}></img>
                </div>
            </div>
...
function MobileMenu({ isModalOpen, closeModal, addTask, summary, setSummary, description, setDescription, dueDate, setDueDate }) {
    return (
        <>
            <div
                id="authentication-modal"
