...
splitAlarmDate = alarmDate.split(", ");
splitAlarmDay = splitAlarmDate[0].split("-")
if (splitAlarmDay.length == 3) {
    currentDate = `${d.getDate()}-${months[d.getMonth()]}-${(d.getFullYear())}`
}
else{
    currentDate = `${d.getDate()}-${months[d.getMonth()]}
}
