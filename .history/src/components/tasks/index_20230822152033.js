...
export const Tasks = () => {
    ...
    return (
        <>
            ...
            <CreateModal handleModalClose={handleModalClose} isModalOpen={isModalOpen} handleClick={handleClick} title={title} author={author} setTitle={setTitle} setAuthor={setAuthor} buttonText={buttonText} />

        </>
    )
}

function CreateModal({ isModalOpen, handleModalClose, handleClick, buttonText }) {
    return (
        <>
            <div
