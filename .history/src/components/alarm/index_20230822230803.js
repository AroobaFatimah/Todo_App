...
export const Alarm = ({ taskDesc = "Submit Resume", taskSummary = "Send resume to office!" }) => {
    return (
        <>
                    ...
                    <div className="w-full max-w-2xl max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-5">
                                <div>
                                    <div>
                                        <h3 className='text-md font-bold' taskDesc={taskDesc}>{taskDesc}</h3>
                                        <p taskDesc={taskDesc}>{taskDesc}</p>
                                    </div>
                                    <div>
